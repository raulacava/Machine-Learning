...
z2 = (Theta1*a1')'; % 5000x25 // a1*Theta1'
a2 = [ones(m,1),sigmoid(z2)]; % 5000x26
z3 = (Theta2*a2')'; % a2*Theta2';
a3 = sigmoid(z3);
h = a3;
% h = sigmoid(X*theta);
...
delta3 = a3-y2; % 5000x10
delta2 = (delta3*Theta2(:,2:end)).*sigmoidGradient(z2); % 5000x25

Theta1_grad = (1/m)*(delta2'*a1); % 25x5000 x 5000x401
Theta2_grad = (1/m)*(delta3'*a2); % 10x5000 x 5000x26
% grad = (1/m)*(X'*(h-y));
